#!/usr/bin/env python3
"""
Simple Vetty Database Seeding Script
"""
...
def main():
    with app.app_context():
        ...
        vet_services_cat = Category.query.filter_by(name='Veterinary Services').first()
        
        services = [
            {
                'name': 'Complete Health Checkup',
                'description': 'Comprehensive veterinary examination including vaccinations, dental check, and health screening',
                'base_price': 8999,  # $89.99
                'duration': 60,
                'category': vet_services_cat,
                'seller': seller1
            },
            {
        ...
        for service_data in services:
            ...
            if not existing_service:
                service = Service(
                    ...
                    seller=service_data['seller']
                )
                db.session.add(service)
    
        db.session.commit()
        print("✅ Created 2 veterinary services")
